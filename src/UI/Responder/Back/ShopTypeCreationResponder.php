...
class ShopTypeCreationResponder implements ShopTypeCreationResponderInterface
{
    /**
     * @var Environment
     */
    ...
    /**
     * ShopTypeCreationResponder constructor.
    ...
    public function response($redirect = false, FormInterface $form = null): Response
    {
        $redirect ?
            ...
            $response = new Response($this->twig->render('Back/shop-type-creation.html.twig', [
